			...
			while($qr_res->nextHit()) {
				...
				if(($o_config->get("cache_timeout") > 0) && ExternalCache::contains($vs_cache_key,'browse_result')){
					...
					if ($vs_table == 'ca_entities') {
						...
						$vs_data = $qr_res->getWithTemplate("<p></p><p>
							<ifdef code='ca_entities.DadosBiograficos.LocalNascimento'>
								<ifdef code='ca_entities.DadosBiograficos.AnoNascimento'>
									☼ 
								</ifdef>
							</ifdef>        
							<ifdef code='ca_entities.DadosBiograficos.LocalNascimento'>
								<ifnotdef code='ca_entities.DadosBiograficos.AnoNascimento'>
									☼
								</ifnotdef>
							</ifdef>        
							<ifnotdef code='ca_entities.DadosBiograficos.LocalNascimento'>
								<ifdef code='ca_entities.DadosBiograficos.AnoNascimento'>
									☼ 
								</ifdef>
							</ifnotdef>
							...
							<ifdef code='ca_entities.DadosBiograficos.LocalNascimento'>
									^ca_entities.DadosBiograficos.LocalNascimento.hierarchy.preferred_labels%hierarchyDirection=asc%maxLevelsFromBottom=2%delimiter=_(), 
							</ifdef>
							...
							<br>
							<ifdef code='ca_entities.DadosBiograficos.LocalMorte'>
							...
							<ifdef code='ca_entities.DadosBiograficos.LocalMorte'>
								<ifnotdef code='ca_entities.DadosBiograficos.AnoMorte'>
									† 
								</ifnotdef>
							</ifdef>
							
							<ifnotdef code='ca_entities.DadosBiograficos.LocalMorte'>
								<ifdef code='ca_entities.DadosBiograficos.AnoMorte'>
									† 
								</ifdef>
							</ifnotdef>
							...
							<ifdef code='ca_entities.DadosBiograficos.LocalMorte'>
									^ca_entities.DadosBiograficos.LocalMorte.hierarchy.preferred_labels%hierarchyDirection=asc%maxLevelsFromBottom=2%delimiter=_(), 
							</ifdef>
								...
								<div class='bResultListItem' id='row{$vn_id}'>
									<div class='bResultListItemContent'><div class='text-center bResultListItemImg'>{$vs_rep_detail_link}</div>
										<div class='bResultListItemText'>
											<small></small><br/>{$vs_label_detail_link}
