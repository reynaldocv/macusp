...
*/
$vs_result_page = $this->render("Browse/macusp_browse_results_info_html.php");
print $vs_result_page; 


/*$vs_cache_key = md5($vs_browse_key.$vs_current_sort.$vs_sort_dir."info".$vn_start.$vn_hits_per_block.$vn_row_id);
if(($o_config->get("cache_timeout") > 0) && ExternalCache::contains($vs_cache_key,'macusp_browse_results')){
	print ExternalCache::fetch($vs_cache_key, 'macusp_browse_results');
}else{
	$vs_result_page = $this->render("Browse/macusp_browse_results_info_html.php");
	ExternalCache::save($vs_cache_key, $vs_result_page, 'macusp_browse_results');
	print $vs_result_page;
}*/
