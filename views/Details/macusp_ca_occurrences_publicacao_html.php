	...
	<div class="col-sm-7 col-md-7 col-md-offset-1 col-lg-7 col-lg-offset-0">
		...
		<div class="row">			
			<div class='col-sm-6 col-md-6 col-lg-6'>
				<div class="container">
					<!--<div><b><?php print _t("Local da exposição").":"; ?></b> 
					...
					<div class="col-sm-12 ">
						<H6>
							<span style="font-weight:bold; font-size:13px">
								<?php print _t($vs_secao_obras) ?>  (^ca_objects._count)
							</span>
...
<script>
    ...
    {   
        ...
        jQuery.getJSON('<?php print caNavUrl($this->request, '', 'Info', 'noArtwork'); ?>', {idno}, function(data) {
            jQuery("#additional-info").html(data); 
        }); 
    }   
