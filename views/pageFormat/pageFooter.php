...
?>
		...
		<footer id="footer">
			...
			<ul class="list-inline">
				<li><?php print caNavLink($this->request, 'hola', '', '','Page', 'front1'); ?></li>
				<li><?php print caNavLink($this->request, 'hola', '', '','Page', 'front2'); ?></li>
				<li><?php print caNavLink($this->request, 'hola', '', '','Page', 'front3'); ?></li>
