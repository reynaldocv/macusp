 ...
 */
	...
	include("macusp-flags.php"); 


	$vb_has_user_links = (sizeof($va_user_links) > 0);
	$vb_has_flag_links = (sizeof($allFlags) > 0);
...
<?php
	...
	if ($vb_has_flag_links) {
?>
				<button type="button" class="navbar-toggle navbar-toggle-user" data-toggle="collapse" data-target="#flag-navbar-toggle">
					<span class="sr-only">Flag navigation</span>
...
?>
				...
				<button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#bs-main-navbar-collapse-2">
...
<?php
				print caNavLink($this->request, caGetThemeGraphic($this->request, 'logo-macusp.png'), "navbar-brand", "", "","");
?>
...
<?php
	...
	if ($vb_has_flag_links) {
?>
			<div class="collapse navbar-collapse" id="flag-navbar-toggle">
				<ul class="nav navbar-nav">
					<?php print join("\n", $allFlags); ?>
				</ul>
			</div>
...
?>			
			...
			<div class="collapse navbar-collapse" style="background-color:white; margin-right:50px; margin-top:50px" id="bs-main-navbar-collapse-1">
...
?>			
				...
				<ul class="nav navbar-nav navbar-right" id="search-navbar" >
					<li class="dropdown" style="position:relative;">
						<form class="navbar-form navbar-right" role="search" action="<?php print caNavUrl($this->request, '', 'MultiSearch', 'index'); ?>">
							<div class="formOutline">
...
?>
			...
			<div class="collapse navbar-collapse" id="bs-main-navbar-collapse-2">
				<?php include("macusp-menuItems.php"); ?>
			</div>
			
		</div><!-- end container -->
	</nav>
	<div class="container" style="min-height:800px"> <div class="row"> <div class="col-xs-12">
