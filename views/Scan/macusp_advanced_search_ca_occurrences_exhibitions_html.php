...
<!--  MARILDA 19/08/26 ESSE ARQUIVO É DE CONFIGURAÇÃO DO FORMULÁRIO DE BUSCA AVANÇADA DAS EXPOSIÇÕES  -->
...
<div class='advancedContainer'>
	...
	<div class='row'>
		<div class="advancedSearchField col-sm-12">
			...
			{{{ca_occurrences.preferred_labels.name%value=''%label=<?php print _t("Title of Exhibition") ?>}}}
		</div>
	</div>
       <p> </p>    <p> </p>
	<div class='row'>
...
<!-- mudar aqui   MARILDA 14/08/26 ESSE ARQUIVO É DE CONFIGURAÇÃO DO FORMULÁRIO DE BUSCA AVANÇADA DAS EXPOSIÇÕES



	<div class='row'>
		<div class="advancedSearchField col-sm-12">
			<span class='formLabel' data-toggle="popover" data-trigger="hover" data-content="<?php print _t("Search by artists in a exhibition.") ?>">
				<?php print _t("Artist in a exhibition") ?>
			</span>
			{{{ca_entities.preferred_labels.displayname/artista%label=<?php print _t("Artists in a exhibition") ?>}}}
		</div>
	</div>
