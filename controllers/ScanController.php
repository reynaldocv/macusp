 ...
 */
 	...
 	class ScanController extends FindController {
 		 ...
 		 *
 		 */
 		protected $ops_view_prefix = 'Scan';
		...
		//	$vs_search_expression_for_display = $this->opo_result_context->getSearchExpressionForDisplay($vs_search_expression); 
			...
			$this->view->setVar('variables', $va_criteria_for_display);	
			...
			$this->view->setVar("view", $va_search_info['view']);
 			...
 			switch($ps_view) {
 				...
 				case 'timelineData':
 					...
 					$this->render("Scan/browse_results_timelineData_json.php");
 					break;
 				default:
 					$this->render("Scan/advanced_search_template.php"); 
 					break;
 			}
 		}
 		# -------------------------------------------------------
