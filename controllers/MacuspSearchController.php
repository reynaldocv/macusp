 ...
 */
 	...
 	class MacuspSearchController extends FindController {
 		# -------------------------------------------------------
 		/**
 		 *
 		 */
		...
		//	$vs_search_expression_for_display = $this->opo_result_context->getSearchExpressionForDisplay($vs_search_expression); 
			...
			$this->opo_result_context->saveContext();
 			...
 			if ($vn_type_id) {
 				if ($this->render("Browse/macusp_{$vs_class}_{$vs_type}_{$ps_view}_{$vs_format}.php")) { return; }
 			} 
			...
			if ($ps_view === 'map') {
 			...
 			switch($ps_view) {
 				...
 				case 'timelineData':
 					...
 					break;
 				default:
 					$this->render("Browse/macusp_browse_results_html.php");
 					break;
 			}
 		}
 		# -------------------------------------------------------
