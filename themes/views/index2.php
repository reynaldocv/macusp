    <div class="row">
		<div class="col-sm-10 col-sm-offset-1 col-lg-offset-1">
			<H1><?php print _t("About"); ?></H1>
		</div>
	</div>

	<div class="row">
		<div class="col-sm-4 col-lg-offset-1 col-sm-offset-0">
		...
		<div class="col-sm-6 col-sm-offset-1 col-lg-offset-0">
            <div class='macusp-foto'>
                <?php print caGetThemeGraphic($this->request, "macusp-foto1.jpg") ?>
            </div>

			<h6>&nbsp;</h6><address>Archives sdfadsfd asfsdafsdfdsfsdfa sdfafdsafdsfadsfafdsafdsafsdfasda dsfasdfafdsafdsf asd fafdsafaf dsafdsa f dsfadsf dsfafdsaf			100 Second Avenue, 2nd floor<br>			New York, NY 10010</address>
    ...
    <div class="row">
		...
		<div class="col-sm-2 col-sm-offset-1 col-lg-offset-1">
